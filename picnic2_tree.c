...
tree_t* generateSeeds(size_t nSeeds, uint8_t* rootSeed, uint8_t* salt, size_t repIndex, const picnic_instance_t* params)
{
...
size_t revealSeedsSize(size_t numNodes, uint16_t* hideList, size_t hideListSize, const picnic_instance_t* params)
{
...
size_t revealSeeds(tree_t* tree, uint16_t* hideList, size_t hideListSize, uint8_t* output, size_t outputSize, const picnic_instance_t* params)
{
...
int reconstructSeeds(tree_t* tree, uint16_t* hideList, size_t hideListSize,
                     uint8_t* input, size_t inputLen, uint8_t* salt, size_t repIndex, const picnic_instance_t* params)
{
    int ret =  0;
...
static void computeParentHash(tree_t* tree, size_t child, uint8_t* salt, const picnic_instance_t* params)
{
...
void buildMerkleTree(tree_t* tree, uint8_t** leafData, uint8_t* salt, const picnic_instance_t* params)
{
    size_t firstLeaf = tree->numNodes - tree->numLeaves;
...
size_t openMerkleTreeSize(size_t numNodes, uint16_t* missingLeaves, size_t missingLeavesSize, const picnic_instance_t* params)
{
