...
#define LOWMC_BLOCK_SZ LOWMC_BLOCK_SIZE_Picnic3_L1
#define PRIVATE_KEY_SIZE PICNIC_PRIVATE_KEY_SIZE_Picnic3_L1
#define PUBLIC_KEY_SIZE PICNIC_PUBLIC_KEY_SIZE_Picnic3_L1
#define SIGNATURE_SIZE PICNIC_SIGNATURE_SIZE_Picnic3_L1
#define PARAM Picnic3_L1
...
size_t PICNIC_CALLING_CONVENTION picnic3_l1_signature_size(void) {
  return SIGNATURE_SIZE;
}

size_t PICNIC_CALLING_CONVENTION picnic3_l1_get_private_key_size(void) {
  return PRIVATE_KEY_SIZE;
}

size_t PICNIC_CALLING_CONVENTION picnic3_l1_get_public_key_size(void) {
  return PUBLIC_KEY_SIZE;
}

const char* PICNIC_CALLING_CONVENTION picnic3_l1_get_param_name(void) {
  return "picnic3_l1";
}
...
int PICNIC_CALLING_CONVENTION picnic3_l1_sk_to_pk(const picnic3_l1_privatekey_t* sk,
                                                    picnic3_l1_publickey_t* pk) {
  if (!sk || !pk) {
    return -1;
  }
...
int PICNIC_CALLING_CONVENTION picnic3_l1_validate_keypair(const picnic3_l1_privatekey_t* sk,
                                                            const picnic3_l1_publickey_t* pk) {
  if (!sk || !pk) {
    return -1;
  }
...
int PICNIC_CALLING_CONVENTION picnic3_l1_sign(const picnic3_l1_privatekey_t* sk,
...
int PICNIC_CALLING_CONVENTION picnic3_l1_verify(const picnic3_l1_publickey_t* pk,
                                                  const uint8_t* message, size_t message_len,
...
int PICNIC_CALLING_CONVENTION picnic3_l1_read_private_key(picnic3_l1_privatekey_t* key,
                                                            const uint8_t* buf, size_t buflen) {
  if (!key || !buf || buflen < 1) {
    return -1;
  }
...
void PICNIC_CALLING_CONVENTION picnic3_l1_clear_private_key(picnic3_l1_privatekey_t* key) {
