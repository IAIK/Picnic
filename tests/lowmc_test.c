...
static int LowMC_test_vector_129_129_4_1(void) {
  ...
  return lowmc_enc(&lowmc_129_129_4, key, plaintext, ciphertext_expected);
}
...
#if defined(WITH_LOWMC_126_126_4)
    LowMC_test_vector_126_126_4_1, LowMC_test_vector_126_126_4_2,
    LowMC_test_vector_126_126_4_3, LowMC_test_vector_126_126_4_4,
#endif
#if defined(WITH_LOWMC_129_129_4)
