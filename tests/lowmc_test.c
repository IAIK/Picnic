...
static int LowMC_test_vector_126_126_4_1(void) {
  ...
  return lowmc_enc(&lowmc_126_126_4, key, plaintext, ciphertext_expected);
}

static int LowMC_test_vector_126_126_4_2(void) {
  const uint8_t key[16] = {
      0xd9, 0xe2, 0x1, 0x18, 0x3, 0xea, 0x3, 0xf3, 0x66, 0x72, 0xed, 0xa2, 0x6, 0x39, 0x9, 0x78,
  };
  const uint8_t plaintext[16] = {
      0x1a, 0xbe, 0x57, 0x89, 0x9b, 0xe0, 0x23, 0xb, 0x51, 0x94, 0x75, 0x6b, 0xf3, 0x8d, 0x8f, 0x5c,
  };
  const uint8_t ciphertext_expected[16] = {
      0xad, 0x45, 0xbf, 0xc9, 0x6f, 0xcf, 0xb2, 0x86,
      0x4c, 0xc7, 0xe8, 0x4c, 0xbf, 0x75, 0x37, 0x44,
  };

  return lowmc_enc(&lowmc_126_126_4, key, plaintext, ciphertext_expected);
}

static int LowMC_test_vector_126_126_4_3(void) {
  const uint8_t key[16] = {
      0xa9, 0xad, 0x92, 0x56, 0xfc, 0x91, 0x46, 0x7, 0xb2, 0x3d, 0x69, 0x7, 0x28, 0x33, 0xeb, 0xc8,
  };
  const uint8_t plaintext[16] = {
      0x25, 0xf3, 0x5f, 0xe2, 0x2c, 0xba, 0xfb, 0x32, 0x97, 0x75, 0x28, 0xe, 0x7a, 0x13, 0x42, 0xec,
  };
  const uint8_t ciphertext_expected[16] = {
      0x71, 0x28, 0x89, 0xfa, 0x78, 0xbe, 0x75, 0x2a, 0xf, 0xf5, 0x23, 0xd7, 0x53, 0xeb, 0x7a, 0x38,
  };
  return lowmc_enc(&lowmc_126_126_4, key, plaintext, ciphertext_expected);
}

static int LowMC_test_vector_126_126_4_4(void) {
  const uint8_t key[16] = {
      0x29, 0xdc, 0x45, 0x36, 0x63, 0x19, 0xac, 0xe, 0x84, 0xc7, 0xaf, 0xc2, 0x6d, 0x60, 0x87, 0x7c,
  };
  const uint8_t plaintext[16] = {
      0xdd, 0x9d, 0x1e, 0x57, 0xa3, 0x6, 0x8e, 0x82, 0xf9, 0x6d, 0xd2, 0xf2, 0x25, 0x1, 0x8f, 0xe8,
  };
  const uint8_t ciphertext_expected[16] = {
      0xd0, 0x3f, 0x4f, 0xcd, 0x3, 0x91, 0x67, 0x5c, 0xee, 0xdc, 0xc3, 0xf6, 0x43, 0xbe, 0xb7, 0x6c,
  };
  return lowmc_enc(&lowmc_126_126_4, key, plaintext, ciphertext_expected);
}
#endif
...
static int LowMC_test_vector_192_192_4_1(void) {
  ...
  return lowmc_enc(&lowmc_192_192_4, key, plaintext, ciphertext_expected);
}
...
static int LowMC_test_vector_255_255_4_1(void) {
  ...
  return lowmc_enc(&lowmc_255_255_4, key, plaintext, ciphertext_expected);
}
...
#if defined(WITH_LOWMC_126_126_4)
    LowMC_test_vector_126_126_4_1, LowMC_test_vector_126_126_4_2, LowMC_test_vector_126_126_4_3, LowMC_test_vector_126_126_4_4,
#endif
#if defined(WITH_LOWMC_192_192_4)
    LowMC_test_vector_192_192_4_1, LowMC_test_vector_192_192_4_2, LowMC_test_vector_192_192_4_3, LowMC_test_vector_192_192_4_4,
#endif
#if defined(WITH_LOWMC_255_255_4)
    LowMC_test_vector_255_255_4_1, LowMC_test_vector_255_255_4_2, LowMC_test_vector_255_255_4_3, LowMC_test_vector_255_255_4_4,
#endif
};
