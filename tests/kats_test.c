...
static int run_test(picnic_params_t param) {
  static const test_t tests[] = {
      ...
      {KATDIR "/kat_l1_ur.txt", PICNIC_PUBLIC_KEY_SIZE(Picnic_L1_UR),
       PICNIC_PRIVATE_KEY_SIZE(Picnic_L1_FS)},
      {KATDIR "/kat_l1_fs.txt", PICNIC_PUBLIC_KEY_SIZE(Picnic_L1_129_FS),
       PICNIC_PRIVATE_KEY_SIZE(Picnic_L1_129_FS)},
      {KATDIR "/kat_l1_ur.txt", PICNIC_PUBLIC_KEY_SIZE(Picnic_L1_129_UR),
       PICNIC_PRIVATE_KEY_SIZE(Picnic_L1_129_FS)},
      ...
      {KATDIR "/kat_picnic2_l1_fs.txt", PICNIC_PUBLIC_KEY_SIZE(Picnic3_L1_129_FS),
       PICNIC_PRIVATE_KEY_SIZE(Picnic3_L1_129_FS)},
