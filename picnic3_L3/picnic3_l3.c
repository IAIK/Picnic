...
#define LOWMC_BLOCK_SZ LOWMC_BLOCK_SIZE_Picnic3_L3
#define PRIVATE_KEY_SIZE PICNIC_PRIVATE_KEY_SIZE_Picnic3_L3
#define PUBLIC_KEY_SIZE PICNIC_PUBLIC_KEY_SIZE_Picnic3_L3
#define SIGNATURE_SIZE PICNIC_SIGNATURE_SIZE_Picnic3_L3
#define PARAM Picnic3_L3
...
size_t PICNIC_CALLING_CONVENTION picnic3_l3_signature_size(void) {
  return SIGNATURE_SIZE;
}

size_t PICNIC_CALLING_CONVENTION picnic3_l3_get_private_key_size(void) {
  return PRIVATE_KEY_SIZE;
}

size_t PICNIC_CALLING_CONVENTION picnic3_l3_get_public_key_size(void) {
  return PUBLIC_KEY_SIZE;
}

const char* PICNIC_CALLING_CONVENTION picnic3_l3_get_param_name(void) {
  return "picnic3_l3";
}

int PICNIC_CALLING_CONVENTION picnic3_l3_keygen(picnic3_l3_publickey_t* pk,
...
int PICNIC_CALLING_CONVENTION picnic3_l3_sk_to_pk(const picnic3_l3_privatekey_t* sk,
                                                    picnic3_l3_publickey_t* pk) {
  if (!sk || !pk) {
    return -1;
  }
...
int PICNIC_CALLING_CONVENTION picnic3_l3_validate_keypair(const picnic3_l3_privatekey_t* sk,
                                                            const picnic3_l3_publickey_t* pk) {
  if (!sk || !pk) {
    return -1;
  }
...
int PICNIC_CALLING_CONVENTION picnic3_l3_write_public_key(const picnic3_l3_publickey_t* key,
...
int PICNIC_CALLING_CONVENTION picnic3_l3_read_public_key(picnic3_l3_publickey_t* key,
...
int PICNIC_CALLING_CONVENTION picnic3_l3_write_private_key(const picnic3_l3_privatekey_t* key,
                                                             uint8_t* buf, size_t buflen) {
  if (!key || !buf) {
    return -1;
  }
...
int PICNIC_CALLING_CONVENTION picnic3_l3_read_private_key(picnic3_l3_privatekey_t* key,
                                                            const uint8_t* buf, size_t buflen) {
  if (!key || !buf || buflen < 1) {
    return -1;
  }
...
void PICNIC_CALLING_CONVENTION picnic3_l3_clear_private_key(picnic3_l3_privatekey_t* key) {
