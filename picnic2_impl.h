...
/* Helper functions */
void sbox_layer_42_aux(mzd_local_t* d, randomTape_t* tapes);
void sbox_layer_64_aux(mzd_local_t* d, randomTape_t* tapes);
void sbox_layer_85_aux(mzd_local_t* d, randomTape_t* tapes);
