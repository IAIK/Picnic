...
#define LOWMC_L1_129_OR_NULL &lowmc_129_129_4
#else
#define LOWMC_L1_129_OR_NULL NULL
#endif
...
static picnic_instance_t instances[PARAMETER_SET_MAX_INDEX] = {
    ...
    {ENABLE_ZKBPP(LOWMC_L1_129_OR_NULL), 32, 16, 219, 219, 3, 17, 17, 65, 129, 55, 0, 0,
     PICNIC_SIGNATURE_SIZE_Picnic_L1_129_FS, Picnic_L1_129_FS, TRANSFORM_FS, NULL_FNS},
    {ENABLE_ZKBPP(LOWMC_L1_129_OR_NULL), 32, 16, 219, 219, 3, 17, 17, 65, 129, 55, 80, 97,
     PICNIC_SIGNATURE_SIZE_Picnic_L1_129_UR, Picnic_L1_129_UR, TRANSFORM_UR, NULL_FNS},
    {ENABLE_ZKBPP(LOWMC_L3_OR_NULL), 48, 24, 329, 329, 3, 24, 24, 96, 192, 83, 0, 0,
     PICNIC_SIGNATURE_SIZE_Picnic_L3_FS, Picnic_L3_FS, TRANSFORM_FS, NULL_FNS},
    {ENABLE_ZKBPP(LOWMC_L3_OR_NULL), 48, 24, 329, 329, 3, 24, 24, 96, 192, 83, 120, 144,
     PICNIC_SIGNATURE_SIZE_Picnic_L3_UR, Picnic_L3_UR, TRANSFORM_UR, NULL_FNS},
    {ENABLE_ZKBPP(LOWMC_L5_OR_NULL), 64, 32, 438, 438, 3, 32, 32, 128, 255, 110, 0, 0,
     PICNIC_SIGNATURE_SIZE_Picnic_L5_FS, Picnic_L5_FS, TRANSFORM_FS, NULL_FNS},
    {ENABLE_ZKBPP(LOWMC_L5_OR_NULL), 64, 32, 438, 438, 3, 32, 32, 128, 255, 110, 160, 192,
    ...
    {ENABLE_KKW(LOWMC_L1_129_OR_NULL), 32, 16, 252, 36, 16, 17, 17, 65, 129, 55, 0, 0,
     PICNIC_SIGNATURE_SIZE_Picnic2_L1_129_FS, Picnic2_L1_129_FS, TRANSFORM_FS, NULL_FNS},
