...
#define LOWMC_L1_OR_NULL &lowmc_129_129_4
#else
...
static picnic_instance_t instances[PARAMETER_SET_MAX_INDEX] = {
    ...
    {ENABLE_ZKBPP(LOWMC_L1_OR_NULL), 32, 16, 219, 219, 3, 17, 17, 65, 129, 55, 0, 0,
     PICNIC_SIGNATURE_SIZE_Picnic_L1_FS, Picnic_L1_FS, TRANSFORM_FS, NULL_FNS},
    {ENABLE_ZKBPP(LOWMC_L1_OR_NULL), 32, 16, 219, 219, 3, 17, 17, 65, 129, 55, 80, 97,
    ...
    // Picnic3 params
    {ENABLE_KKW(LOWMC_L1_OR_NULL), 32, 16, 252, 36, 16, 17, 17, 65, 129, 55, 0, 0,
