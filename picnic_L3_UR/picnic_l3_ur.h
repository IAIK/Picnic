...
#ifndef Picnic_L3_UR_H
#define Picnic_L3_UR_H
...
/** Public key */
typedef struct {
  uint8_t data[PICNIC_PUBLIC_KEY_SIZE_Picnic_L3_UR - 1];
} picnic_l3_ur_publickey_t;

/** Private key */
typedef struct {
  uint8_t data[PICNIC_PRIVATE_KEY_SIZE_Picnic_L3_UR - 1];
 ...
 */
PICNIC_EXPORT const char* PICNIC_CALLING_CONVENTION picnic_l3_ur_get_param_name(void);
 ...
 */
PICNIC_EXPORT size_t PICNIC_CALLING_CONVENTION picnic_l3_ur_get_private_key_size(void);
 ...
 */
PICNIC_EXPORT size_t PICNIC_CALLING_CONVENTION picnic_l3_ur_get_public_key_size(void);
 ...
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION picnic_l3_ur_keygen(picnic_l3_ur_publickey_t* pk,
                                                                picnic_l3_ur_privatekey_t* sk);
 ...
 * bytes required for a parameter set is given by picnic_l3_ur_signature_size(). Note
 ...
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION picnic_l3_ur_sign(const picnic_l3_ur_privatekey_t* sk,
 ...
 * @see picnic_sign()
 */
PICNIC_EXPORT size_t PICNIC_CALLING_CONVENTION picnic_l3_ur_signature_size();
 ...
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION picnic_l3_ur_verify(const picnic_l3_ur_publickey_t* pk,
                                                                const uint8_t* message,
                                                                size_t message_len,
 ...
 *                 Must have size at least PICNIC_MAX_PUBLIC_KEY_SIZE_picnic_l3_ur bytes.
 * @param[in]  buflen The length of buf, in bytes
 *
 * @return Returns the number of bytes written.
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION
picnic_l3_ur_write_public_key(const picnic_l3_ur_publickey_t* key, uint8_t* buf, size_t buflen);
 ...
 *                 Must be at least PICNIC_MAX_PUBLIC_KEY_SIZE_picnic_l3_ur bytes.
 * @param[in]  buflen The length of buf, in bytes
 *
 * @return Returns 0 on success, or a nonzero value indicating an error.
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION
picnic_l3_ur_read_public_key(picnic_l3_ur_publickey_t* key, const uint8_t* buf, size_t buflen);
 ...
 * @param[out] buf The buffer to write the key to.
 *                 Must have size at least PICNIC_MAX_PRIVATE_KEY_SIZE_picnic_l3_ur bytes.
 * @param[in]  buflen The length of buf, in bytes
 *
 * @return Returns the number of bytes written.
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION
picnic_l3_ur_write_private_key(const picnic_l3_ur_privatekey_t* key, uint8_t* buf, size_t buflen);
 ...
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION
picnic_l3_ur_read_private_key(picnic_l3_ur_privatekey_t* key, const uint8_t* buf, size_t buflen);
 ...
 */
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION picnic_l3_ur_validate_keypair(
    const picnic_l3_ur_privatekey_t* privatekey, const picnic_l3_ur_publickey_t* publickey);
...
picnic_l3_ur_clear_private_key(picnic_l3_ur_privatekey_t* key);
 ...
 * @return Returns 0 on success, or a nonzero value indicating an error.
 **/
PICNIC_EXPORT int PICNIC_CALLING_CONVENTION picnic_l3_ur_sk_to_pk(
    const picnic_l3_ur_privatekey_t* privatekey, picnic_l3_ur_publickey_t* publickey);
