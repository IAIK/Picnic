...
int PICNIC_CALLING_CONVENTION picnic_sign(const picnic_privatekey_t* sk, const uint8_t* message,
  ...
  if (param == Picnic3_L1_FS || param == Picnic3_L1_129_FS || param == Picnic3_L3_FS || param == Picnic3_L5_FS) {
#if defined(WITH_KKW)
...
const char* PICNIC_CALLING_CONVENTION picnic_get_param_name(picnic_params_t parameters) {
  ...
  case Picnic_L1_129_FS:
    return "Picnic_L1_129_FS";
  case Picnic_L1_129_UR:
    return "Picnic_L1_129_UR";
  case Picnic_L3_FS:
    return "Picnic_L3_FS";
  case Picnic_L3_UR:
    return "Picnic_L3_UR";
  ...
  case Picnic_L5_UR:
    return "Picnic_L5_UR";
  case Picnic3_L1_FS:
    return "Picnic3_L1_FS";
  case Picnic3_L1_129_FS:
    return "Picnic3_L1_129_FS";
  case Picnic3_L3_FS:
