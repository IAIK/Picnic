...
#define bitsliced_mm_step_2(sc, type, XOR, ROR)                                                    \
  do {                                                                                             \
    for (unsigned int m = 0; m < sc; ++m) {                                                        \
...
#define mpc_mm_and_def(type, AND, XOR, ROR, res, first, second, r, viewshift)                      \
  do {                                                                                             \
...
#define mpc_mm_and_verify_def(type, AND, XOR, ROL, ROR, res, first, second, r, MASK, viewshift)    \
  for (unsigned m = 0; m < (SC_VERIFY - 1); ++m) {                                                 \
    const unsigned j = m + 1;                                                                      \
                                                                                                   \
    res[m] = XOR(AND(first[m], second[m]), AND(first[j], second[m]));                              \
...
static void mpc_sbox_prove_s128_lowmc_126_126_4(mzd_local_t* out, const mzd_local_t* in,
  ...
  // a & b
  mpc_mm_and_def(word128, mm128_and, mm128_xor, mm128_shift_right, r0m, x0s, x1s, r2m, 0);
  // b & c
  mpc_mm_and_def(word128, mm128_and, mm128_xor, mm128_shift_right, r2m, x1s, x2m, r1s, 1);
  // c & a
  mpc_mm_and_def(word128, mm128_and, mm128_xor, mm128_shift_right, r1m, x0s, x2m, r0s, 2);

  bitsliced_mm_step_2(SC_PROOF, word128, mm128_xor, mm128_shift_right);
}
...
static void mpc_sbox_verify_s128_lowmc_126_126_4(mzd_local_t* out, const mzd_local_t* in,
  ...
  // a & b
  mpc_mm_and_verify_def(word128, mm128_and, mm128_xor, mm128_shift_left, mm128_rotate_right, r0m,
                        x0s, x1s, r2m, mask_126_126_42_c->w128[0], 0);
  // b & c
  mpc_mm_and_verify_def(word128, mm128_and, mm128_xor, mm128_shift_left, mm128_rotate_right, r2m,
                        x1s, x2m, r1s, mask_126_126_42_c->w128[0], 1);
  // c & a
  mpc_mm_and_verify_def(word128, mm128_and, mm128_xor, mm128_shift_left, mm128_rotate_right, r1m,
                        x0s, x2m, r0s, mask_126_126_42_c->w128[0], 2);

  bitsliced_mm_step_2(SC_VERIFY, word128, mm128_xor, mm128_shift_right);
}
...
static void mpc_sbox_prove_s256_lowmc_126_126_4(mzd_local_t* out, const mzd_local_t* in, view_t* view, const rvec_t* rvec) {
  bitsliced_mm_step_1(SC_PROOF, word256, mm256_and, mm256_rotate_left, mask_126_126_42_a->w256,
                      mask_126_126_42_b->w256, mask_126_126_42_c->w256);

  // a & b
  mpc_mm_and_def(word256, mm256_and, mm256_xor, mm256_rotate_right, r0m, x0s, x1s, r2m, 0);
  // b & c
  mpc_mm_and_def(word256, mm256_and, mm256_xor, mm256_rotate_right, r2m, x1s, x2m, r1s, 1);
  // c & a
...
static void mpc_sbox_verify_s256_lowmc_126_126_4(mzd_local_t* out, const mzd_local_t* in,
                                                 view_t* view, const rvec_t* rvec) {
  bitsliced_mm_step_1(SC_VERIFY, word256, mm256_and, mm256_rotate_left, mask_126_126_42_a->w256,
                      mask_126_126_42_b->w256, mask_126_126_42_c->w256);

  // a & b
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r0m,
                        x0s, x1s, r2m, mask_126_126_42_c->w256, 0);
  // b & c
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r2m,
                        x1s, x2m, r1s, mask_126_126_42_c->w256, 1);
  // c & a
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r1m,
                        x0s, x2m, r0s, mask_126_126_42_c->w256, 2);
...
static void mpc_sbox_verify_s256_lowmc_192_192_4(mzd_local_t* out, const mzd_local_t* in,
  ...
  // a & b
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r0m,
                        x0s, x1s, r2m, mask_192_192_64_c->w256, 0);
  // b & c
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r2m,
                        x1s, x2m, r1s, mask_192_192_64_c->w256, 1);
  // c & a
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r1m,
                        x0s, x2m, r0s, mask_192_192_64_c->w256, 2);
...
static void mpc_sbox_verify_s256_lowmc_255_255_4(mzd_local_t* out, const mzd_local_t* in,
  ...
  // a & b
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r0m,
                        x0s, x1s, r2m, mask_255_255_85_c->w256, 0);
  // b & c
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r2m,
                        x1s, x2m, r1s, mask_255_255_85_c->w256, 1);
  // c & a
  mpc_mm_and_verify_def(word256, mm256_and, mm256_xor, mm256_rotate_left, mm256_rotate_right, r1m,
                        x0s, x2m, r0s, mask_255_255_85_c->w256, 2);
