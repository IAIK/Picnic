...
const uint32_t* LMatrix(uint32_t round, const picnic_instance_t* params);

/* Return the LowMC key matrix for this round */
const uint32_t* KMatrix(uint32_t round, const picnic_instance_t* params);

/* Return the LowMC round constant for this round */
const uint32_t* RConstant(uint32_t round, const picnic_instance_t* params);
